...
class ClinicRemoteDataSource {
  ClinicRemoteDataSource({ClinicApiClient? apiClient})
  ...
  Future<Map<String, dynamic>> fetchClinicsPayload() {
    return _apiClient.get('/');
  }

  List<Clinic> mapPayloadToClinics(Map<String, dynamic> payload) {
  ...
  Clinic _mapFacilityToClinic(Map<String, dynamic> json) {
    ...
    final name =
        _readString(json['facilityName']) ?? _readString(json['name']) ?? 'Clinic';
    ...
    final location =
        _parseLatitudeLongitude(_readString(json['latitudeLongitude'])) ??
            _fallbackLocation;
...
List<String> _buildServices(Map<String, dynamic> json) {
  final values = <String>{
    ...
    if (_readString(json['facilitySubType']) != null)
      _readString(json['facilitySubType'])!,
    if (_readString(json['primaryHealthCareUnit']) != null)
      _readString(json['primaryHealthCareUnit'])!,
    if (_readString(json['referralLinkage']) != null)
      _readString(json['referralLinkage'])!,
  };
